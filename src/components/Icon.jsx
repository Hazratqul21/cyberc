// Premium stroke ikonalar to'plami (Lucide uslubi, 24×24, currentColor)
const ICONS = {
  dashboard: (
    <>
  ...
  sparkles: (
    <>
      <path d="M9.94 14.06A2 2 0 0 0 8.5 12.63l-4.88-1.26a.5.5 0 0 1 0-.97L8.5 9.14a2 2 0 0 0 1.44-1.44l1.26-4.88a.5.5 0 0 1 .97 0l1.26 4.88a2 2 0 0 0 1.44 1.44l4.88 1.26a.5.5 0 0 1 0 .97l-4.88 1.26a2 2 0 0 0-1.44 1.44l-1.26 4.88a.5.5 0 0 1-.97 0z" />
